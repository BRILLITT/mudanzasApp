            ...
            <footer  className='footer1'>
                <Row>
                    ...
                    <Col className='footer_2_card'>
                        <Row><h1>VISITA NUESTRO <br/>CANAL</h1><br/></Row>
                        <Row><iframe width="350" height="315" src="https://www.youtube.com/embed/0o1iRla5ff8" title="TOSCANOS | EMPRESA QUE OFRECE SERVICIOS DE MUDANZAS EN LIMA | 50 IDEAS DE NEGOCIOS RENTABLES EN PERÚ"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe></Row>
                        
                        
                    </Col>

                    <Col className='enlaces' >
                        <Row><h1>ENLACES</h1><br/><br/></Row>
